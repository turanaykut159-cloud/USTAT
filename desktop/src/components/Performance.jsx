/**
 * ÜSTAT v5.0 — Performans Analizi ekranı.
 *
 * Bölümler:
 ...
 *
 * Veri: getPerformance, getTradeStats, getTrades (1000 kayıt)
 */
...
import { getPerformance, getTradeStats, getTrades } from '../services/api';
...
export default function Performance() {
  ...
  const winRateTrend = useMemo(() => {
    ...
    const window = 20;
    const result = [];
    // Kronolojik sıra (en eskiden en yeniye)
