# USTAT v5.7 — Masaustu Kisa Yol Olusturucu
# Calistirma: PowerShell -ExecutionPolicy Bypass -File create_shortcut.ps1

$WshShell = New-Object -ComObject WScript.Shell
$ShortcutPath = [System.IO.Path]::Combine($WshShell.SpecialFolders("Desktop"), "USTAT v5.7.lnk")
...
$Shortcut.Description = "USTAT v5.7 VIOP Algorithmic Trading"
